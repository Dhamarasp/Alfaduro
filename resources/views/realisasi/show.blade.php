                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="nama">Biaya Anggaran</label>
                                <input type="text" class="form-control" disabled
                                    value="{{ 'Rp ' . number_format($rencana->anggaranRealisasi, 0, ',', '.') }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="nama">Jumlah Barang</label>
                                <input type="text" class="form-control" disabled value="{{ $rencana->jumlahRealisasi }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-header-form">
                                {{-- <div class="input-group">
                                    <a href="{{ route('rencana.create', $rencana->id) }}" class="btn
                                btn-primary">Tambah
                                Barang</a>
                            </div> --}}
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-md">
                                ...
                                <tr>
                                    ...
                                    <td>{{ 'Rp ' . number_format($data->hargaBarangRealisasi, 0, ',', '.') }}</td>
                                    <td>{{ $data->jumlahBarangRealisasi }}</td>
                                    <td>{{'Rp ' . number_format($data->jumlahBarangRealisasi * $data->hargaBarangRealisasi, 0, ',', '.') }}</td>
                                    <td> @if ($data->status == 1)
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('realisasi.edit', $data->id) }}"
